            ...
            if (
                ...
                (s = s === undefined ? 0 : s),
                    ...
                    t
                        ...
                        .append(
                            '<div class="tp-fullwidth-forcer" style="width:100%;height:' + t.height() + 'px"></div>'
                        ),
        ...
        prepareSlides = function (e, u) {
            ...
            e.parent().css({ overflow: "visible" }),
                u.allli.find(">img").each(function (e) {
                    ...
                    var d = jQuery(
                        '<div class="tp-bgimg defaultimg ' + n + '" data-bgcolor="' + s + '" style=' + l + "></div>"
                    );
                    i.parent().append(d);
                        ...
                        ("failed" == i.progress
                            ...
                            : !i.error && jQuery.now() - i.starttoload < 5e3
                              ...
                              : i.reported ||
                                ((i.reported = !0),
                                console.warn(
                                    "Static Image " + i.src + "  Could not be loaded within 5s! Error Exists:" + i.error
                                )));
                }),
                l
